...
ALPHA_MAX = 2.0
SPEAKER_EMB_DIM = 192
ENABLE_SPEAKER_ADAPTERS = os.getenv("ENABLE_SPEAKER_ADAPTERS", "").strip().lower() in {"1", "true", "yes", "on"}
SPEAKER_ADAPTER_LAYERS = os.getenv("SPEAKER_ADAPTER_LAYERS", "")
SPEAKER_ADAPTER_HIDDEN_DIM = int(os.getenv("SPEAKER_ADAPTER_HIDDEN_DIM", "256"))
