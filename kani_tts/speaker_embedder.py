"""
Speaker embedder utilities for the packaged Kani TTS API.

Uses SpeechBrain ECAPA-TDNN embeddings so packaged inference matches the
retrained dataset speaker space.
"""
...
class SpeakerEmbedder:
    """Generate 192-dim ECAPA speaker embeddings from raw audio."""
