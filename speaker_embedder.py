...
Adapted from:
https://raw.githubusercontent.com/nineninesix-ai/kani-tts-2/refs/heads/main/kani_tts/speaker_embedder.py
"""
...
class TopLayers(nn.Module):
    ...
    def __init__(self, embd_size: int = 128, top_interm_size: int = 512):
...
class SpeakerEmbedder:
    ...
    Features:
        ...
        - Handles variable-length audio (max 20–30 seconds recommended)
